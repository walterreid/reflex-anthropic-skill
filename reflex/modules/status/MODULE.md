...
Report what's been produced in the current session.
...
1. Review the workspace state above.
2. If files exist, summarize what's been researched and analyzed — targets, key themes, what stage the work is at.
...
A brief status report: what's done, what's available, what could come next. Keep it to 5-10 lines.
